...
{
    static QString css = Style::getStylesheet(":css/css/innerStyle.css");
...
QVariant CustomTextDocument::loadResource(int type, const QUrl &name)
{
    ...
    {
        QSize size = QSize(SaveSetting::getInstance().getEmojiFontPointSize(),SaveSetting::getInstance().getEmojiFontPointSize());
