...
{
    loadingMutex.lock();
    QtConcurrent::run(this, &SmileyPack::load, SaveSetting::getInstance().getSmileyPack());
    //connect(&SaveSetting::getInstance(), &SaveSetting::smileyPackChanged, this, &SmileyPack::onSmileyPackChanged);
}
